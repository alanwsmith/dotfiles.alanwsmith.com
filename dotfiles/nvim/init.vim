...
" If you need to uninstall a plugin remove it from this config and do this
...
call plug#begin("~/.vim/plugged")
    ...
    " Telescope install March 2022
    Plug 'nvim-lua/plenary.nvim'
    Plug 'nvim-telescope/telescope.nvim'



    " Testing smoothe scrolling
    " It's okay, but doesn't seem to work with default keys
    " so not that intersted. Turning off for now
...
" This is for `Plug 'karb94/neoscroll.nvim'`:
" details: https://github.com/karb94/neoscroll.nvim
" Doesn't seem to work with default bindings. Turning off for now
" lua require('neoscroll').setup()


" Turn off the syntax highlighting around TODO 
hi clear TODO
